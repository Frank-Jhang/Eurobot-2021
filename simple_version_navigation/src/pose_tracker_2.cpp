...
pose_tracker::pose_tracker(){
  ...
  odom_sub_ =  n.subscribe<nav_msgs::Odometry>("global_filter",1,&pose_tracker::get_now_pose,this);
...
int main(int argc, char **argv)
{
  ...
  // ROS_INFO("nononon");
  // while ( !(tfBuffer.canTransform("map","base_footprint",ros::Time(0),ros::Duration(0.5))) ){
