...
class string_with_header {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new string_with_header(null);
  ...
  static datatype() {
    ...
    return 'main_loop/string_with_header';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new string_with_header(null);
...
module.exports = string_with_header;
